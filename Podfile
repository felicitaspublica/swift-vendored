...
target 'DummyIOSApp' do
  ...
  pod 'PINRemoteImage', :git => 'https://github.com/pinterest/PINRemoteImage', :branch => 'master', :inhibit_warnings => true
  pod 'Texture', :git => 'https://github.com/TextureGroup/Texture', :branch => 'master', :inhibit_warnings => true
end
